...
(function( factory ) {
	...
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define('jquery.mjs.nestedSortable',[
			"jquery",
			"jquery-ui/sortable"
		], factory );
	} else {
...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'jquery-ui/position',[ "jquery" ], factory );
	} else {
...
(function( factory ) {
	...
	if ( typeof define === "function" && define.amd ) {
		// AMD. Register as an anonymous module.
		define('jquery.ui-contextmenu',[ "jquery", "jquery-ui/menu", "jquery-ui/widget" ], factory );
	} else {
		// Browser globals
		factory( jQuery );
	}
...
define('file_listing/main',["jquery", "jquery.colorbox", "jquery.mjs.nestedSortable", "jquery.cookie", "jquery.ui-contextmenu", "jquery.fileupload", "jquery-ui/autocomplete"], function($) {
    $(function() {
